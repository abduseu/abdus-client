                ...
                <div className="md:flex justify-between items-center gap-12">
                    ...
                    <div className="max-w-3xl space-y-6">
                        <div className="space-y-3 md:space-y-6">
                            ...
                            <p className="text-xl">As a passionate Frontend Developer with expertise in ReactJS and JavaScript (ES6), I love creating interactive, visually stunning, and user-friendly websites. With a proactive approach to staying updated on new technologies, I am committed to continuously improving user experiences through responsive and accessible designs. Let's collaborate to shape the future of the web together!
                            </p>
                        </div>
                        <hr />
